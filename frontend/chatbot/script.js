...
// API Setup 
const APT_KEY = "AIzaSyB6D9LdeKiTerAnCmyCEkMuBZ7ao8-I-NA";
...
const generateBotResponse = async(incomingMessageDiv) => {
    ...
    const requestOptions = {
        ...
        body: JSON.stringify({
            contents: [{
                parts: [{
                  text: `Bạn là một trợ lý AI chuyên về nha khoa. Chỉ trả lời các câu hỏi liên quan đến nha khoa, răng miệng, chăm sóc răng, điều trị nha khoa, v.v. Nếu câu hỏi không liên quan, hãy lịch sự từ chối. Hãy tư vấn chi tiết, giải thích rõ ràng, dễ hiểu cho người không chuyên. Câu hỏi: ${userData.message}`
